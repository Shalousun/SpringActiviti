	...
	$.fn.iconPicker = function (options) {
		...
		return this.each(function () {
			...
			if (!settings.buttonOnly && $(this).data("iconPicker") == undefined) {
				...
				$button = $("<span class=\"input-group-addon pointer\"><i class=\"fa  fa-photo\"></i></span>");
				$this.after($button);
				(function (ele) {
			...
			function createUI($element) {
				...
				$popup.html('<div class="ip-control"> \
						          <ul> \
						            <li><a href="javascript:;" class="btn" data-dir="-1"><span class="fa  fa-arrow-left"></span></a></li> \
						            <li><input type="text" class="ip-search fa  fa-search" placeholder="Search" /></li> \
						            <li><a href="javascript:;"  class="btn" data-dir="1"><span class="fa  fa-arrow-right"></span></a></li> \
						          </ul> \
						      </div> \
