...
win.laydate = function(options){
    ...
    if(options.initDate){
        ...
        var strDt = Dates.parse([de.getFullYear(), de.getMonth()+1, de.getDate()],[de.getHours(), de.getMinutes(), de.getSeconds()],options.format);
