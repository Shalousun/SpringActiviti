...
public class ModelController {
    ...
    public CommonResult deploy(@PathVariable("modelId") String modelId, RedirectAttributes redirectAttributes) {
    ...
    public CommonResult delete(@PathVariable("modelId") String modelId) {
        CommonResult result = new CommonResult();
